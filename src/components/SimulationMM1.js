...
const generateRandomData = (count, arrivalMean, serviceMean) => {
  ...
  const calculateCalculatedData = (data) => {
    ...
    const serverUtilization = serverUtilizationTime / (serverUtilizationTime +serverIdleTime) ;
    const serverIdle = (serverIdleTime) /(serverUtilizationTime +serverIdleTime);

    console.log("serverUtilizationTime: " + serverUtilizationTime + " serverIdleTime: " + serverIdleTime + " serverUtilization : " + serverUtilization + " serverIdle: " + serverIdle );
