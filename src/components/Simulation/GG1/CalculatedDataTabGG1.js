...
const CalculatedDataTab = ({ calculatedData }) => {
  ...
  return (
    <div className="overflow-auto">
      <h2 className="text-center text-3xl text-red-800 font-bold mb-5">Calculated Data</h2>
      <div className="text-center mb-4">
        <h3 className="text-2xl text-red-800 font-bold">Server 1</h3>
      </div>
      <table className="w-full">
        <thead>
          <tr>
            ...
            <th className="text-xl">Expected Service Time</th>
          </tr>
        </thead>
        <tbody>
          {calculatedData.calculatedData.map((data) => (
            <tr key={data.customer}>
              ...
              <td className="text-center py-2 font-bold">{data.expectedServiceTime}</td>
            </tr>
          ))}
        </tbody>
      </table>
      ...
      <div className="mt-8">
        <h3 className="text-2xl text-red-800 font-bold text-center">Server Idle Time and Utilization</h3>
        <table className="w-full">
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td className="py-2 text-center font-bold">{calculatedData.serverIdle.toFixed(2)}%</td>
              <td className="py-2 text-center font-bold">{calculatedData.serverUtilization.toFixed(2)}%</td>
            </tr>
          </tbody>
        </table>
      </div>
