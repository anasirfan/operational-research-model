...
const CalculatedDataTabGG2 = ({ calculatedData }) => {
  return (
    <div className='overflow-auto'>
      <h2 className="text-center text-3xl text-red-800 font-bold ">Calculated Data</h2>
 
      <div className="grid grid-cols-2 gap-8 ">
        <div>
          <h3 className="text-2xl  text-center text-red-800  font-bold mb-4">Server 1</h3>
        ...
        <div>
          <h3 className="text-2xl text-center  text-red-800  font-bold mb-4">Server 2</h3>
          <table className="w-full">
            <thead>
              <tr>
                <th className='text-xl'>Customer</th>
      ...
      <div className="grid grid-cols-2 gap-8 mb-8">
        <div>
          <h3 className="text-2xl font-bold mb-4 text-center text-red-800">Server Idle Time</h3>
          <table className="w-full">
            <thead>
              <tr>
        ...
        <div>
          <h3 className="text-2xl font-bold mb-4 text-center text-red-800">Server Utilization Time</h3>
          <table className="w-full">
            <thead>
              <tr>
                <th className='text-xl'>Server</th>
      ...
      <div>
        <h3 className="text-2xl font-bold mb-4 text-center text-red-800">System Idle and Utilization Time</h3>
        <table className="w-full">
          <thead>
            <tr>
...
export default CalculatedDataTabGG2;
